...
// COCO数据集的标签
static const vector<string> class_names = { "person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat", "traffic light", "fire hydrant",
...
// 测试图片路径
static const string image_file = "../data/zidane.jpg";
//static const string image_file = R"(G:\ML\Yolo\yolov5\yolov5\data\images\zidane.jpg)";
